    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('role', models.CharField(choices=[('P', 'participant'), ('E', 'expert'), ('O', 'organizer')], max_length=1)),
            ],
        ),
        migrations.CreateModel(
            name='Team',
        ...
        migrations.AddField(
            model_name='participant',
            name='year',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='yeti_app.competition'),
        ),
        migrations.CreateModel(
            name='Image',
            fields=[
